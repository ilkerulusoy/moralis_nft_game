...
module.exports = async function (deployer) {
  ...
  await tokenInstance.mint(101,200,10000);
  await tokenInstance.mint(102,200,10000);
  await tokenInstance.mint(103,200,10000);
  await tokenInstance.mint(104,200,10000);
  await tokenInstance.mint(105,200,10000);
  await tokenInstance.mint(106,200,10000);
